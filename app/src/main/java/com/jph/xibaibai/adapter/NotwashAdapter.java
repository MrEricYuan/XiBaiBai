...
public class NotwashAdapter extends BaseAdapter{
    ...
    public NotwashAdapter(List<Product> notWashList,int carType){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Product itemProduct = notWashList.get(position);
        ...
        if(checkState[position]){
            holder.item_selected_img.setImageResource(R.mipmap.place_checked);
        }else {
            holder.item_selected_img.setImageResource(R.mipmap.place_unchecked);
        }
        return convertView;
    }
